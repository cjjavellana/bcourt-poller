...
'ctl00$ContentPlaceHolder1$AvailabilityCheckCtl$timeCtlStart$ddlHour': '{0:01d}'.format(self.start_time),\
...
'ctl00$ContentPlaceHolder1$AvailabilityCheckCtl$timeCtlEnd$ddlHour': '{0:01d}'.format(self.end_time),\
